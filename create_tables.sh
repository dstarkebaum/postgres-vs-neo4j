...
psql -c "CREATE TABLE inCits (id VARCHAR(40), inCit_id VARCHAR(40));"
...
psql -c "CREATE TABLE outCits (id VARCHAR(40), outCit_id VARCHAR(40));"
...
psql -c "CREATE TABLE paper_authors (paper_id VARCHAR(40),author_id INTEGER);"
