...
papers="data/neo4j/papers_header.csv,`echo data/neo4j-unzipped/*papers.csv | tr ' ' ','`"
cites="data/neo4j/cites_header.csv,`echo data/neo4j-unzipped/*cites.csv | tr ' ' ','`"
is_cited_by="data/neo4j/is_cited_by_header.csv,`echo data/neo4j-unzipped/*is_cited_by.csv | tr ' ' ','`"

authors="data/neo4j/authors_header.csv,`echo data/neo4j-unzipped/*authors.csv | tr ' ' ','`"
is_author_of="data/neo4j/is_author_of_header.csv,`echo data/neo4j-unzipped/*is_author_of.csv | tr ' ' ','`"
has_author="data/neo4j/has_author_header.csv,`echo data/neo4j-unzipped/*has_author.csv | tr ' ' ','`"
